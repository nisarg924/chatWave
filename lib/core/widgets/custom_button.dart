...
class CustomButton extends StatelessWidget {
  const CustomButton({super.key, required this.text, required this.onPressed, this.miniWidth, this.height, this.elevation, this.btnBgColor, this.textStyle});
  final String text;
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
        style: ElevatedButton.styleFrom(
          elevation: 0, backgroundColor: btnBgColor ?? Theme.of(context).colorScheme.primary,
